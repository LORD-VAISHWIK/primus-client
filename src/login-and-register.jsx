                ...
                <div className="space-y-2">
                    <div className="flex gap-2">
                        <div className="flex-1 flex items-center bg-black/20 rounded-md border border-white/10 focus-within:ring-2 focus-within:ring-[#20B2AA]">
                            <AtSymbolIcon className="w-5 h-5 text-gray-400 ml-3" />
                            <input type="email" placeholder="Email Address" value={email} onChange={(e)=>setEmail(e.target.value)} className="flex-1 p-2.5 bg-transparent outline-none placeholder-gray-400"/>
                        </div>
                        {!otpVerified && (
                            <button 
                                type="button" 
                                ...
                                onClick={sendOTP}
                                className="px-4 py-2.5 bg-[#20B2AA] hover:bg-[#1aa19b] text-white text-sm font-semibold rounded-md transition-colors disabled:opacity-60 whitespace-nowrap"
                            >
                    ...
                    {otpSent && (
                        <div className="bg-black/20 rounded-md border border-white/10 p-3">
                            <p className="text-sm text-gray-400 mb-3 text-center">Enter the 6-digit OTP sent to your email</p>
                            <div className="flex justify-center gap-2 mb-3">
                                {otp.map((digit, index) => (
                                    <input
                                        ...
                                        className={`w-10 h-10 text-center bg-transparent border-2 rounded-md outline-none text-white font-semibold ${
                                            otpVerified 
                                                ? 'border-green-500' 
                                                : 'border-white/20 focus:border-[#20B2AA]'
                                        }`}
                            ...
                            {!otpVerified && (
                                <button
                                    ...
                                    onClick={verifyOTP}
                                    className="w-full bg-[#20B2AA] hover:bg-[#1aa19b] text-white font-semibold py-2 rounded-md transition-colors disabled:opacity-60 text-sm"
                                >
